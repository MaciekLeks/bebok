...
cq: [nvme_ncqr]NvmeDriver.q.Queue(NvmeDriver.q.CQEntry) = undefined, //+1 for admin cq
//cq: [nvme_ncqr + 1]Queue(CQEntry) = undefined, //+1 for admin
sq: [nvme_nsqr]NvmeDriver.q.Queue(NvmeDriver.q.SQEntry) = undefined, //+1 for admin sq
